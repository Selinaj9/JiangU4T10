...
public class WordScrambleTester {
    ...
    public static void main(String[] args) {
        ...
        String result8 = WordScramble.scrambleWord("ABCAABCAABCA");
        testScramble(result8, "BACABACABACA", 8);
        String result9 = WordScramble.scrambleWord("CAADEAAFGAAH");
        testScramble(result9, "CADAEAFAGAHA", 9);
        String result10 = WordScramble.scrambleWord("ABBBABBAB");
        testScramble(result10, "BABBBABBA", 10);
        String result11 = WordScramble.scrambleWord("AABCDEFGAA");
        testScramble(result11, "ABACDEFGAA", 11);
        ...
        testScrambleRemove(testWordList, expectedAfterScrambleRemove, 12);
        ArrayList<String> testWordList2 = new ArrayList<String>(Arrays.asList("SPELL", "PEAR", "SPEAK", "CORONET", "PAPAP", "BELL", "BALL"));
        WordScramble.scrambleOrRemove(testWordList2);
        ArrayList<String> expectedAfterScrambleRemove2 = new ArrayList<String>(Arrays.asList("PERA", "SPEKA", "PPAPA", "BLAL"));
        testScrambleRemove(testWordList2, expectedAfterScrambleRemove2, 13);
        System.out.println("--------------------------------------------------");
